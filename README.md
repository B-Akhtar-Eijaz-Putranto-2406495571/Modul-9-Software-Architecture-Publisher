...
Dengan menjalankan tiga subscriber sekaligus, sistem dapat menerapkan strategi horizontal scaling di mana beban kerja dibagi rata ke setiap instance yang aktif. Hal ini menyebabkan antrean pesan pada RabbitMQ diproses secara paralel, sehingga tumpukan pesan berkurang jauh lebih cepat dibandingkan saat hanya menggunakan satu subscriber. Untuk pengembangan lebih lanjut, sistem ini bisa ditingkatkan dengan mekanisme penanganan kesalahan (error handling) yang lebih baik pada sisi subscriber untuk memastikan tidak ada pesan yang hilang jika salah satu instance mengalami kegagalan.